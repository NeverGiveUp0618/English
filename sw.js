...
const FILES = [
  "./", "./index.html", "./data.js", "./app.js", "./manifest.json", "./audio/manifest.js", "./audio/baibai/manifest.js", ...Object.values(BAIBAI_AUDIO), "./assets/baibai-base.png", ...Array.from({length:29},(_,i)=>`./assets/poses/pose-${String(i+2).padStart(2,"0")}.webp`),
