...
/* 三至六年级上下册拼读目录。每条规则都带可听读、可拆音节的例词；
   原有四年级内容保留，下面补齐其余六册，并补充五、六年级常见组合。 */
function phonicPack(id, book, label, ipa, icon, tip, re, rows) {
  return { id, book, label, ipa, icon, tip, re, words: rows.map(x => ({ w:x[0], zh:x[1], e:x[2], ipa:x[3], syl:x[4] || [x[0]] })) };
}
PHONICS.push(
  phonicPack("ph9","三上","短音 a","/æ/","🐱","a 在闭音节里常读短音 /æ/。","a",[["cat","猫","🐱","/kæt/"],["bag","书包","🎒","/bæɡ/"],["hand","手","✋","/hænd/"],["map","地图","🗺️","/mæp/"]]),
  phonicPack("ph10","三上","短音 e","/e/","🥚","e 在闭音节里常读短音 /e/。","e",[["pen","钢笔","🖊️","/pen/"],["red","红色","🔴","/red/"],["leg","腿","🦵","/leɡ/"],["ten","十","🔟","/ten/"]]),
  phonicPack("ph11","三下","短音 i","/ɪ/","🐷","i 在闭音节里常读短音 /ɪ/。","i",[["pig","猪","🐷","/pɪɡ/"],["six","六","6️⃣","/sɪks/"],["milk","牛奶","🥛","/mɪlk/"],["fish","鱼","🐟","/fɪʃ/"]]),
  phonicPack("ph12","三下","短音 o / u","/ɒ/ /ʌ/","🦆","短元音要读得短而有力。","(?:o|u)",[["dog","狗","🐶","/dɒɡ/"],["box","盒子","📦","/bɒks/"],["duck","鸭子","🦆","/dʌk/"],["bus","公共汽车","🚌","/bʌs/"]]),
  phonicPack("ph13","五上","y 结尾","/i/ /aɪ/","🦋","y 在词尾常读 /i/，短词中也可读 /aɪ/。","y$",[["happy","快乐的","😄","/ˈhæpi/",["hap","py"]],["baby","婴儿","👶","/ˈbeɪbi/",["ba","by"]],["sunny","晴朗的","☀️","/ˈsʌni/",["sun","ny"]],["sky","天空","🌌","/skaɪ/"]]),
  phonicPack("ph14","五上","ow","/aʊ/ /əʊ/","🐄","ow 有两个常见读音，要放进单词里辨认。","ow",[["cow","奶牛","🐄","/kaʊ/"],["flower","花","🌸","/ˈflaʊə(r)/",["flow","er"]],["snow","雪","❄️","/snəʊ/"],["window","窗户","🪟","/ˈwɪndəʊ/",["win","dow"]]]),
  phonicPack("ph15","五下","cl / pl","/kl/ /pl/","☁️","两个辅音连读，每个音都要轻轻带出来。","(?:cl|pl)",[["clock","时钟","🕰️","/klɒk/"],["class","班级","🏫","/klɑːs/"],["plate","盘子","🍽️","/pleɪt/"],["plant","植物","🌱","/plɑːnt/"]]),
  phonicPack("ph16","五下","br / gr","/br/ /ɡr/","🍇","辅音组合开头不加额外元音。","(?:br|gr)",[["brown","棕色","🟤","/braʊn/"],["bread","面包","🍞","/bred/"],["green","绿色","🟢","/ɡriːn/"],["grape","葡萄","🍇","/ɡreɪp/"]]),
  phonicPack("ph17","六上","er / ir / ur","/ɜː/","🐦","er、ir、ur 常能发出相近的卷舌长音。","(?:er|ir|ur)",[["her","她的","👧","/hɜː(r)/"],["bird","鸟","🐦","/bɜːd/"],["girl","女孩","👧","/ɡɜːl/"],["nurse","护士","🧑‍⚕️","/nɜːs/"]]),
  phonicPack("ph18","六上","ar / or","/ɑː/ /ɔː/","⭐","r 会改变前面元音的发音。","(?:ar|or)",[["car","汽车","🚗","/kɑː(r)/"],["star","星星","⭐","/stɑː(r)/"],["horse","马","🐴","/hɔːs/"],["short","短的","📏","/ʃɔːt/"]]),
  phonicPack("ph19","六下","air / ear","/eə/ /ɪə/","👂","三个字母可以合作发成一个双元音。","(?:air|ear)",[["hair","头发","💇","/heə(r)/"],["chair","椅子","🪑","/tʃeə(r)/"],["ear","耳朵","👂","/ɪə(r)/"],["near","附近","📍","/nɪə(r)/"]]),
  phonicPack("ph20","六下","tion / sion","/ʃən/ /ʒən/","🚉","常见名词词尾要整体识读。","(?:tion|sion)",[["station","车站","🚉","/ˈsteɪʃən/",["sta","tion"]],["action","行动","🎬","/ˈækʃən/",["ac","tion"]],["vision","视野","👀","/ˈvɪʒən/",["vi","sion"]],["television","电视","📺","/ˈtelɪvɪʒən/",["tel","e","vi","sion"]]])
);
