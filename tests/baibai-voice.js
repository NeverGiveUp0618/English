...
const bbAudios=()=>audios.filter(a=>/audio\/baibai\/[a-f0-9]+\.mp3/.test(a.src));

(async()=>{
  console.log("白白中文小奶狗声线");
  const manifestContext={};vm.createContext(manifestContext);vm.runInContext(fs.readFileSync(DIR+"/audio/baibai/manifest.js","utf8"),manifestContext);
