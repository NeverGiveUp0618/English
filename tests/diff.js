...
t(rows.find(r => r.n === 0).lv === 1 && rows.find(r => r.n === 24).lv === 1, "0~24词 = 1段（新手，一整个四上Unit1+2都在新手区）");
t(rows.find(r => r.n === 25).lv === 2 && rows.find(r => r.n === 59).lv === 2, "25~59词 = 2段");
t(rows.find(r => r.n === 60).lv === 3, "60词+ = 3段");
// 家长锁定
